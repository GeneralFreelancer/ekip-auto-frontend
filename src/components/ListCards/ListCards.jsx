...
let cardsData = [
    {
        ...
        title:' Lampa is wery good lampaLampa is wery good lampaLampa is wery good',
        priceUAH: '5000',
        priseUSD: '500',
        inStock: true,
    },
     {
        id: 2,
        imgUrl:'https://w7.pngwing.com/pngs/235/163/png-transparent-ghost-drawing-halloween-ghost-pics-white-marine-mammal-fictional-character.png',
      ...
      {
        id: 3,
        imgUrl:'https://w.forfun.com/fetch/9d/9db2d4683d92f5f2045e9142fbd82633.jpeg',
        title:'Lampa is wery good lampa',
        priceUAH: '5000',
          priseUSD: '500',
        inStock: false
    ...
    },
     {
      ...
      {
        id: 8,
        imgUrl:'https://upload.wikimedia.org/wikipedia/commons/thumb/7/7d/LetterG.svg/800px-LetterG.svg.png',
        title:'Lampa is wery good lampa',
        priceUAH: '5000',
          priseUSD: '500',
        inStock: true
...
const ListCards = ({ title = 'Product', showAll = false, link}) => {
  ...
  if (!showAll) {
      return cardsToShow.map(({ id, imgUrl, title, priceUAH, priseUSD, inStock }, index) => (
      <Card
        key={id}
        id={id}
        imgUrl={imgUrl}
    ...
    return cards.map(({ id, imgUrl, title, priceUAH, priseUSD, inStock }, index)=> (
      <Card
        key={id}
        id={id}
        imgUrl={imgUrl}
