...
let numberOfProducts0 = [
    {
        id: 1,
        imgUrl:'https://imagedelivery.net/4_JwVYxosZqzJ7gIDJgTLA/ab4d8dc6-f0ca-439d-eda2-79b95d74e800/16x9',
...
const [showModal, setShowModal] = useState(false);
  ...
  const removeFromBasket = (id) => {
    setNumberOfProducts((prevProducts) => prevProducts.filter((product) => product.id !== id));
  };

    return (
        <>
            <div
                className={style.wrapperShoppingCard}
                onMouseEnter={handleMouseEnter}
                onMouseLeave={handleMouseLeave}
            >
                <ShoppingCard className={style.shoppingCard} />
            ...
            {showModal && (
                ...
                >
                    {numberOfProducts.length
                        ...
                        :
                        <p className={style.textAlert}>Ви ще не зробили жодного замовлення</p>
                    }
